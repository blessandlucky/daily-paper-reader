...
## 摘要
基于深度学习的现代蛋白质设计方法能够生成具有多样几何结构和功能的定制蛋白质支架。在本研究中，我们利用这些最新进展开发了具有钴原卟啉 IX 辅因子 (CoPPIX) 的超热稳定从头设计二氧化碳还原酶。通过在培养基中添加钴盐，在体内组装了含有 CoPPIX 的酶，并评估了其光催化二氧化碳还原活性。我们鉴定了两种半胱氨酸配位的设计，它们表现出高活性（转化数 >1000，速率高达 25 min-1），同时抑制了竞争性的析氢途径。2.1 Å 的晶体结构显示其与设计模型高度一致，Co-Cys 键按预期进行了编程。本研究展示了计算蛋白质设计在开发人工酶以激活二氧化碳等挑战性分子方面的强大能力。
