...
tldr: 本研究利用深度学习蛋白质设计方法，开发出一种超热稳定的从头设计CO2还原酶。该酶采用半胱氨酸配位的钴原卟啉IX（CoPPIX）作为辅因子，通过体内组装实现。实验表明，该设计在光催化CO2还原中表现出高活性（超过1000次周转）并能有效抑制竞争性的析氢反应，晶体结构验证了设计的精确性，为人工酶激活挑战性分子提供了新思路。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在利用先进的蛋白质设计技术开发高效且具有选择性的从头设计CO2还原酶。
method: 采用基于深度学习的蛋白质支架设计，并结合半胱氨酸配位的钴原卟啉IX辅因子进行体内组装。
result: 成功筛选出两种高活性设计，其周转数超过1000次，且晶体结构与设计模型高度吻合。
conclusion: 该研究证明了计算蛋白质设计在开发用于激活CO2等挑战性分子的人工酶方面的巨大潜力。
---
