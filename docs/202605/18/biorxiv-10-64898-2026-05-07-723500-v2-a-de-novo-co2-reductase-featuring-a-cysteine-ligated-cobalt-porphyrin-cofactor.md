...
title_zh: 一种具有半胱氨酸配位钴卟啉辅因子的从头设计二氧化碳还原酶
authors: "Radley, E., Andrews, A., Kalvet, I., Deng, Y., Levy, C., Ortmayer, M., Heyes, D., Megarity, C., Nunez-Franco, R., Hutton, A., Lu, Y., Baker, D., Green, A."
date: 2026-05-10
pdf: "https://www.biorxiv.org/content/10.64898/2026.05.07.723500v2.full.pdf"
...
score: 7.0
evidence: 在二氧化碳还原中抑制竞争性的析氢路径
tldr: 本研究利用深度学习蛋白质设计技术，开发出一种超热稳定的从头设计CO2还原酶。该酶以半胱氨酸连接的钴卟啉IX（CoPPIX）为辅因子，通过体内组装实现。实验表明，该设计在光催化CO2还原中表现出高活性（超过1000次周转）并能有效抑制竞争性的析氢反应。晶体结构验证了设计模型的准确性，展示了计算设计在激活CO2等挑战性分子方面的巨大潜力。
source: biorxiv
selection_source: fresh_fetch
motivation: 旨在利用深度学习蛋白质设计方法，开发能够高效且具有选择性地还原CO2的人工酶。
method: 通过计算设计超热稳定支架，并在体内组装半胱氨酸连接的钴卟啉辅因子，随后进行光催化活性评估和晶体结构分析。
result: 成功鉴定出两种具有高催化活性和低析氢副反应的设计，其周转数超过1000次，且晶体结构与设计模型高度吻合。
conclusion: 该研究证明了从头蛋白质设计在创建具有特定几何结构和功能的人工金属酶以解决复杂化学挑战方面的有效性。
---

## 摘要
基于深度学习的现代蛋白质设计方法允许生成具有多样几何结构和功能的定制化蛋白质支架。在本文中，我们利用这些最新进展开发了具有钴原卟啉 IX 辅因子（CoPPIX）的超热稳定从头设计二氧化碳还原酶。含有 CoPPIX 的酶通过在培养基中添加钴盐在体内组装，并对其光催化二氧化碳还原活性进行了评估。我们鉴定了两种半胱氨酸配位的设计，它们表现出高活性（转化数 >1000，速率高达 25 min-1），同时抑制了竞争性的析氢途径。2.1 Å 的晶体结构显示其与设计模型高度一致，Co-Cys 键按预期构建。本研究展示了计算蛋白质设计在开发人工酶以激活二氧化碳等挑战性分子方面的强大能力。
